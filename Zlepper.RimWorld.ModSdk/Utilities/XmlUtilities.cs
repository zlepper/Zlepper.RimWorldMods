...
public static class XmlUtilities
{
        ...
        where T : notnull
    {
        ...
        xmlWriter.WriteComment(
            " Generated by Zlepper.RimWorld.ModSdk, please do NOT edit by hand. Your changes will be lost on next build. ");
        serializer.Serialize(xmlWriter, o, ns);
    }
    ...
    public static void WriteSchemaToFile(string filePath, XsdSchema schema)
    {
        FileUtilities.EnsureDirectory(Path.GetDirectoryName(filePath)!);
